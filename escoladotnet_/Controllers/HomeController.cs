...
public class HomeController : Controller
{
    ...
    {   //var - declaração da variável
        ...
        var curso = new Curso(){ //
           ...
           Descricao = "Domine a programação em C# com nosso curso completo - aprenda desde o básico até o avançado e desenvolva suas próprias aplicações com confiança",
